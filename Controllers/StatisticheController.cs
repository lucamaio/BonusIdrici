...
namespace BonusIdrici2.Controllers
{
    public class StatisticheController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.TotaleDomande = _context.Reports.Count();
           ...
           var reportPerEnte = _context.Reports
            ...
            ViewBag.ReportLabels = reportPerEnte.Select(x => x.NomeEnte.ToString()).ToList();
            ViewBag.ReportValues = reportPerEnte.Select(x => x.Totale).ToList();

            // Grafico 2: Domande per esito

             var domandePerEsito = _context.Reports
